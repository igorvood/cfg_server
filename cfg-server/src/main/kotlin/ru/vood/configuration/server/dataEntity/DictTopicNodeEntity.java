package ru.vood.configuration.server.dataEntity;
...
@GenerateJpa(tableComment = "Нода графа Топик", genRest = true, readOnly = false)
public class DictTopicNodeEntity {
    @Id
    @Column(name = "id", nullable = false)
    private String id;
    @Basic
    @Column(name = "node_type", updatable = false, nullable = false)
