...
import ru.vtb.jpaprocessor.generator.model.AbstractAnnotatedClass
...
class TemplateSearchServiceGenerator(
    private val orIsNullSearchInterface: AbstractAnnotatedClass, private val methods: List<OrIsNullSearchMethod>
) {
