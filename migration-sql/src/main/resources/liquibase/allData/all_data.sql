...
select 'producer_idempotence', 'value.serializer', 'org.apache.kafka.common.serialization.ByteArrayDeserializer', 'prd' from dual  union
...
select 0, 'model-vector-bevents', 'transactional.id', 'model-vector_transactionId', 'uasp-streaming-model-vector' from dual  union
