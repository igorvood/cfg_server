...
select 'rto_graph', 'topic', 'dev_bevents_68_after_rate_enrich', 'flink_srv', 'uasp-kriaa-bevents-case-2~main', 'enrichOne.MainEnrichProperty$.fromTopic', 'consumer_default' from DUAL union
select 'rto_graph', 'topic', 'dev_bevents_68_after_rate_enrich', 'flink_srv', 'uasp-kriaa-bevents-case-40~main', 'enrichOne.MainEnrichProperty$.fromTopic', 'consumer_default' from DUAL union
select 'rto_graph', 'topic', 'dev_multibonus_partners_program', 'flink_srv', 'uasp-kriaa-bevents-case-40~main', 'multiBonus.MultiBonusEnrichProperty$.fromTopic', 'consumer_default' from DUAL union
select 'rto_graph', 'topic', 'dev_bevents_68_after_rate_enrich', 'flink_srv', 'uasp-kriaa-bevents-case-68~main', 'enrichOne.MainEnrichProperty$.fromTopic', 'consumer_default' from DUAL union
...
select 'rto_graph', 'topic', 'dev_ivr__uasp_realtime__input_converter__mortgage__uaspdto', 'flink_srv', 'uasp-streaming-mdm-enrichment~way4', 'enrichOne.CommonEnrichProperty$.fromTopic', 'consumer_default' from DUAL union
select 'rto_graph', 'topic', 'dev_ivr__uasp_realtime__input_converter__mdm_cross_link__uaspdto', 'flink_srv', 'uasp-streaming-mdm-enrichment~way4', 'enrichOne.GlobalIdEnrichProperty$.fromTopic', 'consumer_default' from DUAL union
...
select 'rto_graph', 'topic', 'dev__dko_uasp__card_agreement_converted', 'flink_srv', 'uasp-streaming-mdm-enrichment~way4-card-agreement', 'enrichOne.CommonEnrichProperty$.fromTopic', 'consumer_default' from DUAL union
...
select 'rto_graph', 'topic', 'dev_input_converter_cardfl_refill_uasp', 'flink_srv', 'uasp-streaming-mdm-enrichment~case-68', 'enrichOne.CommonEnrichProperty$.fromTopic', 'consumer_default' from DUAL union
...
select 'rto_graph', 'topic', 'dev__dko_uasp__card_agreement_converted', 'flink_srv', 'uasp-streaming-mdm-enrichment~case-68_agrement', 'enrichOne.CommonEnrichProperty$.fromTopic', 'consumer_default' from DUAL union
...
select 'rto_graph', 'topic', 'dev__dko_uasp__card_agreement_converted', 'flink_srv', 'uasp-streaming-mdm-enrichment~prof-auth', 'enrichOne.GlobalIdEnrichProperty$.fromTopic', 'consumer_default' from DUAL union
...
select 'rto_graph', 'topic', 'dev_ivr__uasp_realtime__ca_ha_aggregate__ca__uaspdto', 'flink_srv', 'uasp-streaming-aggregate~aggregate-dko', 'consumer.ca.topic.name', 'consumer_default'  from DUAL union
...
select 'rto_graph', 'topic', 'dev_ivr__uasp_realtime__mdm_enrichment__uaspdto', 'flink_srv', 'uasp-streaming-aggregate~aggregate-dko', 'consumer.ha.topic.name', 'consumer_default'  from DUAL union
select 'rto_graph', 'topic', 'dev_ivr__uasp_realtime__input_converter__way4_issuing_operation__json', 'flink_srv', 'uasp-streaming-input-convertor~input-convertor-w4-operation', 'way4.input.topic.name', 'consumer_default'  from DUAL union
...
select 'rto_graph', 'topic', 'dev__dko_uasp__pension_converted', 'flink_srv', 'uasp-streaming-mdm-enrichment~prof-auth-packNM', 'enrichOne.CommonEnrichProperty$.fromTopic', 'consumer_default' from DUAL union
...
select 'rto_graph', 'topic', 'dev_rto_batch_ca_deposit_account_case_71_json_converted', 'flink_srv', 'uasp-streaming-mdm-enrichment~prof-tx-case-71', 'enrichOne.CommonEnrichProperty$.fromTopic', 'consumer_default' from DUAL union
...
select 'rto_graph', 'topic', 'dev_bevents__batch__ca_regulatory_client_id_of_profile__json_converted', 'flink_srv', 'uasp-streaming-mdm-enrichment~profile-tx-step1', 'enrichOne.GlobalIdEnrichProperty$.fromTopic', 'consumer_default' from DUAL union
...
select 'rto_graph', 'topic', 'dev_bevents__batch__ca_regulatory_contract_num_of_mdm_id_profile__uaspdto', 'flink_srv', 'uasp-streaming-mdm-enrichment~profile-tx-step2', 'enrichOne.GlobalIdEnrichProperty$.fromTopic', 'consumer_default' from DUAL union
